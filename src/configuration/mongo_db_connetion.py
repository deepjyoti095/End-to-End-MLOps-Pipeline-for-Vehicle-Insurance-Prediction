...
class MongoDBClient:
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        database_name : str, optional
            Name of the MongoDB database to connect to. Default is set by DATABSE_NAME constant.
        ...
        try:
            ...
            if MongoDBClient.client is None:
                ...
                if mongo_db_url is None:
                    raise Exception(f"Environment varaible {MONGODB_URL_KEY} is not set.")
            ...
            # raise a custome exception with traceback details if connection fails
